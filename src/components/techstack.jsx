...
import { SiGoland, SiTailwindcss, SiFlutter, SiJavascript, SiTypescript, SiPostgresql, SiFirebase } from "react-icons/si";
...
function TechStack({ darkMode }) {
  const skills = [
    ...
    { name: "Tailwind", icon: <SiTailwindcss className="text-[#38BDF8] w-12 h-12" /> },
